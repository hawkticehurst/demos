...
`}const lf=(t,e)=>{const i=rf(t),s=t.tagFor(we);return q`
        <template
            ...
            ${Ea({property:"rowElements",filter:Fo("[role=row]")})}
        >
            <slot></slot>
        </template>
...
`}const hf=(t,e)=>{const i=df(t),s=uf(t);return q`
        <template
            ...
            ${Ea({property:"cellElements",filter:Fo('[role="cell"],[role="gridcell"],[role="columnheader"],[role="rowheader"]')})}
        >
...
`;let ig=class extends Ct{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Option")}};const sg=ig.compose({baseName:"option",template:Ef,styles:tg}),ng=(t,e)=>re`
	${$e("grid")} :host {
		box-sizing: border-box;
		font-family: ${Qe};
		font-size: ${_e};
...
`;class Sg extends Ee{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const Ig=Sg.compose({baseName:"text-area",template:Xf,styles:Tg,shadowOptions:{delegatesFocus:!0}}),Og=(t,e)=>re`
	${$e("inline-block")} :host {
		font-family: ${Qe};
		outline: none;
		user-select: none;
